...
export default component$(() => {
    ...
    if (!available || !name || !price || !count || !prizes) {
        errorMessage.value = _`Invalid raffle link. Please contact the organizer.`;
    } else {
    ...
    if (errorMessage.value) {
        return (
            <div class="p-4 max-w-7xl mx-auto">
                <h1 class="text-2xl font-bold text-purple-800 dark:text-purple-300">{_`Error`}</h1>
...
export const head: DocumentHead = () => {
    return {
        title: _`Qwik Raffle - View Available Numbers`,
        meta: [
            {
                name: "description",
                content: _`View and select available raffle numbers`,
            },
        ],
    };
};
