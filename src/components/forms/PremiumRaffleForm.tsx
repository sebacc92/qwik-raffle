...
import { type RaffleForm, type RaffleResponseData, PremiumRaffleSchema } from '~/schemas/raffleSchema'
...
export default component$(() => {
    ...
    const [raffleForm, { Form, Field, FieldArray }] = useForm<RaffleForm, RaffleResponseData>({
        ...
        fieldArrays: ['prizes'],
        validate: valiForm$(PremiumRaffleSchema)
    })
                        ...
                        <div class="space-y-1.5 flex-1">
                            ...
                            <div class="text-xs text-muted-foreground mt-1">
                                <span class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 mr-1 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                    {_`Premium accounts support up to 10,000 numbers`}
                                </span>
                            </div>
                        </div>
                    )}
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="text-xs text-muted-foreground">
                        <span class="flex items-center">
                            ...
                            {_`Premium accounts have unlimited prizes`}
                        </span>
                    </div>
                </div>
                            ...
                            <button
                                ...
                                onClick$={() => {
                                    ...
                                    if (numberCount && fieldArray.items.length >= numberCount) {
                                        toast.error(_`Number of prizes (${fieldArray.items.length}) must be less than the number count (${numberCount})`);
                                        return;
                                    }
